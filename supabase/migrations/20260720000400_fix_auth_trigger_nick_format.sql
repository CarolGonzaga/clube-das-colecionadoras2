...
-- estritamente compatíveis com a restrição profiles_nick_format 
-- (apenas letras minúsculas e números) e únicos, e remove o underline.
-- ============================================================
...
BEGIN
  ...
  -- usa um nick único gerado a partir do UUID da usuária sem caracteres especiais
  IF clean_nick = '' THEN
