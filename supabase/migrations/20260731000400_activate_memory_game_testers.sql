-- Libera o Jogo da Memoria somente para as mesmas contas de teste do Caca-Palavras.
begin;
...
values
  ('a2c66f5b-6cba-4984-a256-c189051e6630', 'memory_game', true, now(), null, null, now()),
  ('483f4e4b-20b0-4340-a1bb-4666acd54b32', 'memory_game', true, now(), null, null, now()),
  ('f8721040-035f-414a-8153-b5e12fec64d7', 'memory_game', true, now(), null, null, now())
...
values (
  'memory_game_enabled',
  'true'::jsonb,
  'Desliga ou liga globalmente o Jogo da Memoria.',
  now()
)
